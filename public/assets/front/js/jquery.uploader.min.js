(() => {
    ...
    class h {
        ...
        checkOptions() {
            ...
            if ("file" !== this.$originEle.attr("type") && this.$originEle.attr("type")) throw `url模式下，元素的类型只能为 file,不能为 ${this.$originEle.attr("type")}`;
        }
        initEle() {
            if (
