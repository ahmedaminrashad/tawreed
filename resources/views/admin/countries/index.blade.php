...
<li class="nav-item d-none d-sm-inline-block">
    <a href="javascript::void(0);" class="nav-link">Countries</a>
</li>
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="text_search" name="text_search" placeholder="Countries Search">
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{ route('admin.countries.create') }}"><button class="btn btn-primary"><i class="fa fa-plus"></i> Create Country</button></a>
                        </div>
                        @endcan()
                    </div>
                    <div class="card-body">
                        <table id="countries_table" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>VAT</th>
...
<script>
    $(function() {
        var showURL = '{{ route('admin.countries.show', ['country'=>'#id']) }}';
        var editURL = '{{ route('admin.countries.edit', ['country'=>'#id']) }}';
		var deleteURL = '{{ route('admin.countries.destroy', ['country'=>'#id']) }}';
            ...
            , columns: [{
                ...
                , {
                    ...
                    , fnCreatedCell: function(nTd, sData, oData, iRow, iCol) {
                        ...
                        var btnTitle = "Delete Country";
                        var btnClass = "btn-danger";

                        var statusUrl = deleteURL.replace('#id', oData.id);
                        var name = 'Country #' + oData.id;
                        var title = name.replaceAll(" ", "_");


                        html += "<a title=" + btnTitle + " href='javascript:void(0)' class='edit btn btn-sm delete_country " + btnClass + "' id=" + oData.id + " label='" + title + "' url='" + statusUrl + "'>" + btnIcon + "</a>";
                        @endcan
        ...
        $(document).on("click", ".delete_country", function() {
            ...
            var alertMessage = "Are you sure to delete this Country (<strong>" + finalLable + "</strong>) ?";
            var successMessage = "Country (<strong>" + finalLable + "</strong>) was deleted successfully";
