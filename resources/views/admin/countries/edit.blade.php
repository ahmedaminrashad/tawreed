...
<li class="nav-item d-none d-sm-inline-block">
    <a href="{{ route('admin.countries.show', ['country' => $country->id]) }}" class="nav-link">Country - {{ $country->translate('ar')->name }}</a>
</li>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.countries.show', ['country' => $country]) }}">Country - {{ $country->translate('ar')->name }}</a></li>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ old($locale . '_name') ?? $country->translate($locale)->name }}" name="{{ $locale }}_name" id="{{ $locale }}_name" placeholder="Enter Name in {{ $name }}">
                            </div>
                            @endforeach
