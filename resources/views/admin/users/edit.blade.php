                ...
                <div class="card">
                    ...
                    <form action="{{ route('admin.users.update', $user) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="type" class="form-control select2" required>
                                            <option value="individual" {{ $user->type->value === 'individual' ? 'selected' : '' }}>Individual</option>
                                            <option value="company" {{ $user->type->value === 'company' ? 'selected' : '' }}>Company</option>
                                        </select>
                                    </div>

                                    <div class="form-group individual-fields" style="display: {{ $user->type->value === 'individual' ? 'block' : 'none' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group company-fields" style="display: {{ $user->type->value === 'company' ? 'block' : 'none' }}">
                                        ...
                                        <textarea class="form-control" id="company_desc" name="company_desc" rows="3">{{ old('company_desc', $user->company_desc) }}</textarea>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="latitude" name="latitude" value="{{ old('latitude', $user->latitude) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="longitude">Longitude</label>
                                                <input type="text" class="form-control" id="longitude" name="longitude" value="{{ old('longitude', $user->longitude) }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group company-fields" style="display: {{ $user->type->value === 'company' ? 'block' : 'none' }}">
                                        ...
                                        <input type="text" class="form-control" id="tax_card_number" name="tax_card_number" value="{{ old('tax_card_number', $user->tax_card_number) }}">
                                    </div>

                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="email_notify" name="email_notify" value="1" {{ old('email_notify', $user->email_notify) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="push_notify" name="push_notify" value="1" {{ old('push_notify', $user->push_notify) ? 'checked' : '' }}>
                            ...
                            <div class="row company-fields" style="display: {{ $user->type->value === 'company' ? 'block' : 'none' }}">
                                <div class="col-md-6">
                                    <div class="form-group">
