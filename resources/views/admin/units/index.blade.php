...
<li class="nav-item d-none d-sm-inline-block">
    <a href="javascript::void(0);" class="nav-link">Measurement Units</a>
</li>
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="text_search" name="text_search" placeholder="Measurement Units Search">
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{ route('admin.units.create') }}"><button class="btn btn-primary"><i class="fa fa-plus"></i> Create Measurement Unit</button></a>
                        </div>
                        @endcan()
                    </div>
                    <div class="card-body">
...
<script>
    $(function() {
        var showURL = '{{ route('admin.units.show', ['unit'=>'#id']) }}';
        var editURL = '{{ route('admin.units.edit', ['unit'=>'#id']) }}';
		var deleteURL = '{{ route('admin.units.destroy', ['unit'=>'#id']) }}';
            ...
            , columns: [{
                ...
                , {
                    ...
                    , fnCreatedCell: function(nTd, sData, oData, iRow, iCol) {
                        ...
                        var btnTitle = "Delete Measurement Unit";
                        var btnClass = "btn-danger";

                        var statusUrl = deleteURL.replace('#id', oData.id);
                        var name = 'Measurement Unit #' + oData.id;
                        var title = name.replaceAll(" ", "_");


                        html += "<a title=" + btnTitle + " href='javascript:void(0)' class='edit btn btn-sm delete_unit " + btnClass + "' id=" + oData.id + " label='" + title + "' url='" + statusUrl + "'>" + btnIcon + "</a>";
                        @endcan
        ...
        $(document).on("click", ".delete_unit", function() {
            ...
            var alertMessage = "Are you sure to delete this Measurement Unit (<strong>" + finalLable + "</strong>) ?";
            var successMessage = "Measurement Unit (<strong>" + finalLable + "</strong>) was deleted successfully";
