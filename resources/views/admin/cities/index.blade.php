...
<li class="nav-item d-none d-sm-inline-block">
    <a href="javascript::void(0);" class="nav-link">Cities</a>
</li>
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="text_search" name="text_search" placeholder="Cities Search">
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{ route('admin.cities.create') }}"><button class="btn btn-primary"><i class="fa fa-plus"></i> Create City</button></a>
                        </div>
                        @endcan()
                    </div>
                    <div class="card-body">
...
<script>
    $(function() {
        var showURL = '{{ route('admin.cities.show', ['city'=>'#id']) }}';
        var editURL = '{{ route('admin.cities.edit', ['city'=>'#id']) }}';
		var deleteURL = '{{ route('admin.cities.destroy', ['city'=>'#id']) }}';
            ...
            , columns: [{
                ...
                , {
                    ...
                    , fnCreatedCell: function(nTd, sData, oData, iRow, iCol) {
                        ...
                        var btnTitle = "Delete City";
                        var btnClass = "btn-danger";

                        var statusUrl = deleteURL.replace('#id', oData.id);
                        var name = 'City #' + oData.id;
                        var title = name.replaceAll(" ", "_");


                        html += "<a title=" + btnTitle + " href='javascript:void(0)' class='edit btn btn-sm delete_city " + btnClass + "' id=" + oData.id + " label='" + title + "' url='" + statusUrl + "'>" + btnIcon + "</a>";
                        @endcan
        ...
        $(document).on("click", ".delete_city", function() {
            ...
            var alertMessage = "Are you sure to delete this City (<strong>" + finalLable + "</strong>) ?";
            var successMessage = "City (<strong>" + finalLable + "</strong>) was deleted successfully";
