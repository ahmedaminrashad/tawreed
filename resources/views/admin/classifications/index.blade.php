...
@section('title', 'Work Category Classifications')
...
<li class="nav-item d-none d-sm-inline-block">
    <a href="javascript::void(0);" class="nav-link">Work Category Classifications</a>
</li>
@endsection
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Work Category Classifications</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="text_search" name="text_search" placeholder="Work Category Classifications Search">
                                </div>
                            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Work Category Classifications</h3>
                        @can('create-classifications')
                        <div class="float-right">
                            <a href="{{ route('admin.classifications.create') }}"><button class="btn btn-primary"><i class="fa fa-plus"></i> Create Work Category Classification</button></a>
                        </div>
                        @endcan()
                    </div>
                    <div class="card-body">
...
<script>
    $(function() {
        var showURL = '{{ route('admin.classifications.show', ['classification'=>'#id']) }}';
        var editURL = '{{ route('admin.classifications.edit', ['classification'=>'#id']) }}';
		var deleteURL = '{{ route('admin.classifications.destroy', ['classification'=>'#id']) }}';
        ...
        var table = $('#classifications_table').DataTable({
            ...
            , serverSide: true
            , responsive: true
            , ajax: "{{ route('admin.classifications.index') }}"
            , columns: [{
                    data: 'ar_name'
                    , name: 'ar_name'
                }
                , {
                    ...
                    , fnCreatedCell: function(nTd, sData, oData, iRow, iCol) {
                        ...
                        var btnTitle = "Delete Work Category Classification";
                        var btnClass = "btn-danger";

                        var statusUrl = deleteURL.replace('#id', oData.id);
                        var name = 'Work Category Classification #' + oData.id;
        ...
        $(document).on("click", ".delete_classification", function() {
            ...
            var alertMessage = "Are you sure to delete this Work Category Classification (<strong>" + finalLable + "</strong>) ?";
            var successMessage = "Work Category Classification (<strong>" + finalLable + "</strong>) was deleted successfully";
