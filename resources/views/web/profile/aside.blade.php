<aside class="col-md-4 col-xs-12 hidden-xs hidden-sm">
    <ul>
        ...
        <li @if($active == 'proposals') class="active" @endif><a href="{{ route('profile.proposals') }}"><img src="{{ asset('/assets/front/img/19.svg') }}"> My Proposals</a></li>
        <li @if($active == 'messages') class="active" @endif><a href="javascript:void(0);"><img src="{{ asset('/assets/front/img/20.svg') }}"> Messages</a></li>
        <li @if($active == 'wallet') class="active" @endif><a href="{{ route('profile.wallet') }}"><img src="{{ asset('/assets/front/img/21.svg') }}"> Wallet</a></li>
