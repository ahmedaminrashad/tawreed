        ...
        <div class="container remove-padding add-tender-main add-tender-review">
            ...
            <form id="add-item-form" action="{{ route('tenders.publish', ['tender' => $tender]) }}" method="POST"
                ...
                <div class="col-md-8">
                    <div class="review-item col-xs-12 remove-padding">
                        <div class="review-item-title col-xs-12">
                            ...
                            <a href="{{ route('tenders.create', ['tender' => $tender->id]) }}">{{ __('web.edit') }} <i
                    ...
                    <div class="review-item col-xs-12 remove-padding">
                        <div class="review-item-title col-xs-12">
                            <h4>{{ __('web.items_list') }}
                                <span>({{ $tender->items()->count() }} {{ __('web.items') }})</span></h4>
                            <a href="{{ route('tenders.items.form', ['tender' => $tender->id]) }}">{{ __('web.edit') }}
                ...
                <div class="col-md-4">
                    ...
                    <div class="review-item col-xs-12 remove-padding">
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-12 remove-padding">
                                ...
                                <h6>{{ __('web.time_remaining') }}
                                    <span>{{ $tender->remaining_days }} {{ __('web.days') }} {{ __('web.before_closing_date') }}</span>
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="review-item map-section col-xs-12 remove-padding">
                        <div class="review-item-title col-xs-12">
                            ...
                            <a style="float: right;"
                               href="{{ route('tenders.create', ['tender' => $tender->id]) }}">{{ __('web.edit') }} <i
                                    class="ri-pencil-line"></i></a>
                        </div>
                        <div class="col-xs-12">
                            <div class="col-xs-12 remove-padding">
                                <p><span><i class="ri-map-pin-line"></i></span>{{ $tender->address }} . <a
                                        href="#">{{ __('web.get_direction') }}</a></p>
                                <div id="map"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 tender-review-bottom">
                    ...
                    <a href="{{ route('tenders.items.form', ['tender' => $tender]) }}"
